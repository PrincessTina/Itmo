...
<table cellpadding="0" cellspacing="0" border="1">
    ...
    <tr>
        ...
        <td>
            ...
            <input type="text" id="r" class="field" oninput="checkParams('r')"/>
            <span id="r_span" class="span"></span> <span id="r_tick" class="tick"></span><br/>
            <input type="submit" value="Create graph" id="button1" onclick="createGraph(); checkParams('x')" disabled/><br/>

            <label for="x" class="label">Input X (-5; 5)</label><br/>
            <input type="text" id="x" class="field" oninput="checkParams('x')"/>
            <span id="x_span" class="span"></span> <span id="x_tick" class="tick"></span> <br/>

            <label for="y" class="label">Choose Y</label><br/>
            <select class="field" size="4" id="y">
            ...
            <input type="submit" value="Check!" id="button2" onclick="hello(); addNewPoint()" disabled/>
        </td>
    </tr>
