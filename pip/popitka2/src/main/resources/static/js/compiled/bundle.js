...
function setNullPoints() {
    return {
        type: NULL
    };
}

function setUser(id, login) {
    return {
        type: ADD_USER,
        id: id,
        login: login
...
var _StartPage = __webpack_require__(77);
...
document.onreadystatechange = function () {
    ...
    var store = _Reducer2.default;

    if (index !== 0) {
        var id = window.location.href.substr(index);

        _axios2.default.get('/api/users/' + id).then(function (response) {
            store.dispatch((0, _Actions.setUser)(id, response.data.login));
...
function checkPage(store) {
    if (window.location.href.lastIndexOf("/index.html") !== -1) {
        _reactDom2.default.render(_react2.default.createElement(_StartPage2.default, { store: store }), document.getElementsByClassName("react_root")[0]);
    } else {
        _reactDom2.default.render(_react2.default.createElement(_MainPage2.default, { store: store }), document.getElementsByClassName("react_root")[0]);
    }
}
...
*/
var aa=__webpack_require__(3),l=__webpack_require__(17),B=__webpack_require__(4),C=__webpack_require__(2),ba=__webpack_require__(18),da=__webpack_require__(19),ea=__webpack_require__(20),fa=__webpack_require__(21),ia=__webpack_require__(22),D=__webpack_require__(5);
...
function pointsReducer() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { points: [] };
    var action = arguments[1];

    switch (action.type) {
        case _Actions.ADD_POINT:
            return {
...
var StartPage = function (_React$Component) {
    ...
    _createClass(StartPage, [{
        ...
        value: function getLoginContent() {
            var button = document.getElementsByClassName("w3-button")[0];
        ...
        key: "getHashValue",
        value: function getHashValue(value) {
            var hash = 0;
        ...
        key: "sendPostCall",
        value: function sendPostCall() {
            var login = document.getElementsByClassName("_login")[0];
            var password = document.getElementsByClassName("_password")[0];
            var id = void 0;
            var self = this;
        ...
        value: function sendGetCall() {
            ...
            _axios2.default.get('/api/users/search/findByLogin?login=' + login.value).then(function (response) {
        ...
        key: "setUser",
        value: function setUser(id, login) {
            console.log("Redux store");
            console.log(this.props.store.getState());

            this.props.store.dispatch((0, _Actions.setUser)(id, login));
            console.log(this.props.store.getState());
        }
    }, {
        key: "goNext",
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            "p",
                            null,
                            "Powered by Orlova Kristina Aleksandrovna"
                        ),
                        _react2.default.createElement(
                            "p",
                            null,
                            "Group P3202, Variant 827"
                        )
                    )
                ),
                _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    { className: "w3-text-pink", style: { cursor: 'pointer' },
                                        onClick: this.getLoginContent },
                                    "Login"
                                )
                            ),
                            _react2.default.createElement(
                                "div",
                                { className: "w3-half w3-border-bottom w3-border-left w3-border-pink w3-hover-opacity" },
                                _react2.default.createElement(
                                    "h5",
                                    { style: { cursor: 'pointer' }, onClick: this.getRegContent },
                                    "Sign in"
                                )
                            )
                        ),
                        _react2.default.createElement("div", { className: "w3-section w3-padding" }),
                        _react2.default.createElement(
                            "div",
                            { className: "w3-section" },
                            _react2.default.createElement("i", { className: "fa fa-user w3-text-white", style: { marginRight: '6px' } }),
                            _react2.default.createElement("input", { className: "_login", type: "text", placeholder: "Username", style: { width: '60%' } })
                        ),
                        _react2.default.createElement(
                            "div",
                            { className: "w3-section" },
                            _react2.default.createElement("i", { className: "fa fa-key w3-text-white", style: { marginRight: '2px' } }),
                            _react2.default.createElement("input", { className: "_password", type: "password", placeholder: "Password", style: { width: '60%' } })
                        ),
                        _react2.default.createElement(
                            "button",
                            { className: "w3-button w3-pink w3-center", onClick: this.checkCall.bind(this),
                                style: { width: '59%', marginLeft: '2%' } },
                            "Login"
                        )
                    )
                )
...
var MainPage = function (_React$Component) {
    ...
    function MainPage(props) {
        ...
        _this.initStore = _this.initStore.bind(_this);
    ...
    _createClass(MainPage, [{
        ...
        value: function changeRadius() {
            var r = document.getElementsByClassName("_r")[0];
            ...
            if (this.validate(r.value) && value > 0 && value <= 3) {
                this.props.store.getState().pointsReducer.points.forEach(function (point) {
                    var id = point.id;
                    var result = self.getResult(point.x, point.y, r.value);

                    _axios2.default.put('/api/points/' + id, {
                        x: point.x,
                        y: point.y,
                        r: r.value,
                        result: result,
        ...
        key: "sendPoint",
        value: function sendPoint() {
            var x = document.getElementsByClassName("_x")[0];
            var y = document.getElementsByClassName("_y")[0];
            var r = void 0;
            var result = void 0;
            var self = this;
            var x_value = parseFloat(x.value);
            var y_value = parseFloat(y.value);
            var condition = true;
            ...
            if (this.validate(x.value) && x_value >= -5 && x_value <= 3) {} else {
                condition = false;
                x.classList.add("w3-border-0", "w3-pale-red", "w3-leftbar", "w3-border-red");
            }

            if (this.validate(y.value) && y_value >= -3 && y_value <= 5) {} else {
                condition = false;
            ...
            if (condition) {
                ...
                _axios2.default.post('/api/points', {
                    x: x_value,
                    y: y_value,
                    r: r,
                    result: result,
        ...
        value: function initStore() {
            var self = this;
            var userid = this.props.store.getState().userReducer.user.id;

            this.props.store.dispatch((0, _Actions.setNullPoints)());

            _axios2.default.get('/api/points/search/findByUserid?userid=' + userid).then(function (response) {
                response.data._embedded.points.forEach(function (point) {
                    var id = point._links.point.href.substr(point._links.point.href.lastIndexOf("/") + 1);

                    self.props.store.dispatch((0, _Actions.addPoint)(id, point.x, point.y, point.r, point.result));
                });

                self.props.store.dispatch((0, _Actions.setNullPoints)());
        ...
        key: "getResult",
        value: function getResult(x, y, r) {
            if (x >= -r && x <= 0 && y >= -r && y <= 0 || x ^ 2 + y ^ 2 <= r ^ 2 && x >= -r && x <= 0 && y >= 0 && y <= r || y <= (r - x) / 2 && y >= 0 && y <= r / 2 && x >= 0 && x <= r) {
                return "+";
            } else {
                return "-";
            }
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "div",
                    { className: "w3-container w3-half table",
                        style: {
                            padding: '0',
                            height: '100%',
                    ...
                    _react2.default.createElement(
                        "table",
                        { className: "w3-table-all w3-hoverable", style: { textAlignLast: 'center', border: '0' } },
                        _react2.default.createElement(
                            "thead",
                            null,
                            _react2.default.createElement(
                                "tr",
                                { style: { background: '#1b1520fa', color: 'white' } },
                                _react2.default.createElement(
                                    "th",
                                    null,
                                    "X"
                ...
                _react2.default.createElement(
                    "div",
                    { className: "w3-container w3-half", style: { verticalAlign: 'top', padding: '0' } },
                    _react2.default.createElement("div", { className: "chart" }),
                    _react2.default.createElement(
                        "div",
                        ...
                        _react2.default.createElement(
                            "button",
                            { className: "w3-button w3-pink w3-center", style: { width: '40%', marginLeft: '33%' },
                                onClick: this.changeRadius.bind(this) },
                            "Change radius"
                        ),
                        _react2.default.createElement("div", { className: "w3-black w3-margin-top", style: { width: '100%', height: '2px' } }),
                        _react2.default.createElement("input", { type: "text",
                        ...
                        _react2.default.createElement(
                            "button",
                            { className: "w3-button w3-pink w3-center checkButton",
                                style: { width: '40%', marginLeft: '33%' },
                                onClick: this.sendPoint.bind(this) },
                            "Check point"
                        ),
                        _react2.default.createElement(
                            "a",
