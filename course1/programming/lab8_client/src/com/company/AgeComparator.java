...
class DateComparator implements Comparator<Shorty> {
  public int compare(Shorty a, Shorty b){
    return a.date.format(DateTimeFormatter.ISO_ZONED_DATE_TIME).compareTo(
        b.date.format(DateTimeFormatter.ISO_ZONED_DATE_TIME));
  }
}
