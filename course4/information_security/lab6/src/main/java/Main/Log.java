...
public class Log {
  ...
  /**
   * Подробный вывод расчетов расшифрования шифртекста для одного символа открытого текста
   *
   * @param PmkPb    - вторая точка шифртекста
   * @param kg       - первая точка шифртекста
